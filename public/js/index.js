...
const genreList = {
    ...
    // bikin genre string dari genre_id
...
const heroBanner = function({ results: movieList }) {
    ...
    // EROR BERJAM JAM banner.arialabel -> bannersetAttribute, aria labelnya di dalem
        ...
        sliderItem.innerHTML = `
            ...
            <div class="banner-content">
                ...
                <a href="detail" class="btn" onclick="getMovieDetail(${id})">
                    <img src="assets/play_circle.png" width="24" aria-hidden="true" alt="play circle">

                    <span class="span">See review</span>
                </a>
    ...
    // data dari home page homePageSections(top rated, upcoming, trending)
